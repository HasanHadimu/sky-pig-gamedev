class Player {
    constructor(game){
        ...
        this.barSize;
        this.charging;
        this.image = document.getElementById('player_boar');
        this.frameX;
        this.maxFrame = 9;
        this.frameY;
    }
    ...
    resize(){
        ...
        this.collisionRadius = 60 * this.game.ratio;
    ...
    startCharge(){
        if (this.energy >= this.minEnergy && !this.charging){
            ...
            this.wingsCharge();
            this.game.sound.play(this.game.sound.boost);
        } else {
            this.stopCharge();
        }
    }
    ...
    flap(){
        ...
        if (!this.isTouchingTop()){
            ...
            this.game.sound.play(this.game.sound.antigravitySounds[Math.floor(Math.random() * 5)]);
            this.wingsDown();
        }
    }
}